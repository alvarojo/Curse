...
//Until BC is stable
mods.jei.JEI.removeAndHide(<buildcrafttransport:pipe_wood_fluid>);
mods.jei.JEI.removeAndHide(<buildcrafttransport:pipe_cobble_fluid>);
mods.jei.JEI.removeAndHide(<buildcrafttransport:pipe_stone_fluid>);
mods.jei.JEI.removeAndHide(<buildcrafttransport:pipe_quartz_fluid>);
mods.jei.JEI.removeAndHide(<buildcrafttransport:pipe_iron_fluid>);
mods.jei.JEI.removeAndHide(<buildcrafttransport:pipe_gold_fluid>);
mods.jei.JEI.removeAndHide(<buildcrafttransport:pipe_clay_fluid>);
mods.jei.JEI.removeAndHide(<buildcrafttransport:pipe_sandstone_fluid>);
mods.jei.JEI.removeAndHide(<buildcrafttransport:pipe_void_fluid>);
mods.jei.JEI.removeAndHide(<buildcrafttransport:pipe_diamond_fluid>);
mods.jei.JEI.removeAndHide(<buildcrafttransport:pipe_diamond_wood_fluid>);
mods.jei.JEI.removeAndHide(<buildcrafttransport:waterproof>);
